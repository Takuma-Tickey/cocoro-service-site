...
$jinr_related_sponsor_text = get_option('jinr_related_sponsor_text');
$jinr_related_ads_code_01 = do_shortcode(get_option('jinr_related_ads_code_01'));
$jinr_related_sp_display_01 = get_option('jinr_related_sp_display_01');
$jinr_related_ads_code_02 = do_shortcode(get_option('jinr_related_ads_code_02'));
$jinr_related_sp_display_02 = get_option('jinr_related_sp_display_02');
$jinr_unit_sponsor_text = get_option('jinr_unit_sponsor_text');
$jinr_unit_ads_code = do_shortcode(get_option('jinr_unit_ads_code'));
$jinr_unit_sp_display = get_option('jinr_unit_sp_display');
	...
	if (is_array(${"cat_array_ids" . $i}) && !empty(${"cat_array_ids" . $i})) {
		foreach (${"cat_array_ids" . $i} as $cat_array_id) {
			if ($current_id == $cat_array_id) {
				$jinr_related_sponsor_text = get_option('jinr_related_sponsor_text_' . $i . '');
				$jinr_related_ads_code_01 = do_shortcode(get_option('jinr_related_ads_code_01_' . $i . ''));
				$jinr_related_sp_display_01 = get_option('jinr_related_sp_display_01_' . $i . '');
				$jinr_related_ads_code_02 = do_shortcode(get_option('jinr_related_ads_code_02_' . $i . ''));
				$jinr_related_sp_display_02 = get_option('jinr_related_sp_display_02_' . $i . '');
				$jinr_unit_sponsor_text = get_option('jinr_unit_sponsor_text_' . $i . '');
				$jinr_unit_ads_code = do_shortcode(get_option('jinr_unit_ads_code_' . $i . ''));
				$jinr_unit_sp_display = get_option('jinr_unit_sp_display_' . $i . '');
				continue;
			}
		}
	}
...
if ($jinr_related_sp_display_01 == '1') {
	$jinr_sp_display = '';
} elseif ($jinr_related_sp_display_02 == '1') {
	$jinr_sp_display = '';
} elseif ($jinr_unit_sp_display == '1') {
	$jinr_sp_display = '';
} else {
	$jinr_sp_display = 'd--sp-nonedisplay';
}
?>
<?php if (!$jinr_related_ads_code_01  == null || !$jinr_related_ads_code_02  == null) : ?>
	<div class="o--related-area t--padding">
		<?php if (!$jinr_related_sponsor_text  == null) : ?>
			<div class="a--related-sponser"><?php echo $jinr_related_sponsor_text; ?></div>
		<?php endif; ?>
		<?php if (!$jinr_related_ads_code_01 == null) : ?>
			<section class="c--related-area <?php echo $jinr_related_ads_code_02 == null ? "d--minwidth-100" : ""; ?>  <?php echo $jinr_sp_display; ?>">
				<div class="a--related-rectangle">
					<?php echo $jinr_related_ads_code_01; ?>
				</div>
			</section>
		<?php endif; ?>
		<?php if (!$jinr_related_ads_code_02 == null) : ?>
			<section class="c--related-area <?php echo $jinr_sp_display; ?>">
				<div class="a--related-rectangle">
					<?php echo $jinr_related_ads_code_02; ?>
				</div>
			</section>
		<?php endif; ?>
	</div>
...
<!-- 関連コンテンツユニット -->
<?php if (!$jinr_unit_ads_code  == null) : ?>
	<div class="o--unit-area t--main-width">
		<?php if (!$jinr_unit_sponsor_text  == null) : ?>
			<div class="a--unit-sponser"><?php echo $jinr_unit_sponsor_text; ?></div>
		<?php endif; ?>
		<section class="c--unit-area <?php echo $jinr_sp_display; ?>">
			<div class="a--unit-rectangle">
				<?php echo $jinr_unit_ads_code; ?>
			</div>
		</section>
	</div>
<?php endif; ?>