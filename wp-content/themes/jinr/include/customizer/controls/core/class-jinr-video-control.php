<?php
class Jinr_Upload_Control extends Jinr_Media_Control
{
	/**
	 * Control type.
	 *
...
class Jinr_Media_Control extends WP_Customize_Control
{
		...
		if (is_object($this->setting)) {
			if ($this->setting->default) {
				...
				$default_attachment = array(
					...
					'type'  => $type,
					'icon'  => $type == 'document' ? get_template_directory_uri() . '/include/customizer/img/preset_bg_12.png' : wp_mime_type_icon($type),
					'title' => '',
				);
	...
	{
?>
		<# var descriptionId=_.uniqueId( 'customize-media-control-description-' ); var describedByAttr=data.description ? ' aria-describedby="' + descriptionId + '" ' : '' ; #>
			<# if ( data.label ) { #>
																		...
																		<# if ( data.attachment.artist || data.attachment.meta.artist ) { #>
																			...
																			<# } #>
																				...
																				<# } else if ( 'video'===data.attachment.type ) { #>
																					...
																					<# } else { #>
																						<img class="attachment-thumb type-icon icon" src="<?php echo get_template_directory_uri() . '/lib/img/noimage-1520x855.png'; ?>" draggable="false" alt="" />
																						<p class="attachment-title">{{ data.attachment }}</p>
																						<# } #>
									</div>
									<div class="actions">
										<# if ( data.canUpload ) { #>
